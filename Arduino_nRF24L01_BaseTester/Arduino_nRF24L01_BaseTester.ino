 ...
 */
  ...
  delay(1);
/*
// commando 1 naar node 2.1
 
  radio.openWritingPipe(listeningPipes[2]+1);
  dataOut.command = 1;
  dataOut.destAddr = listeningPipes[2]+1;
  dataOut.dataValue = var++;

#ifdef DEBUG
  Serial.println("Commando 1 send to address: ");
  printf("%ld\n\r", listeningPipes[2]+1);
#endif
...
// commando 1 naar node 2.2

  radio.openWritingPipe(listeningPipes[2]+2);
  dataOut.command = 1;
  dataOut.destAddr = listeningPipes[2]+2;
  dataOut.dataValue = var++;

#ifdef DEBUG
  Serial.println("Commando 1 send to address: ");
  printf("%ld\n\r", listeningPipes[2]+2);
#endif
